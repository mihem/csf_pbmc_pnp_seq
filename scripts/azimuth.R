...
# run Azimuth ----
sc_merge_azimuth <- RunAzimuth(query = sc_merge, reference = "pbmcref", assay = "RNA")
...
predictions_pbmcref <-
    ...
    mutate(azimuth_pbmcref1 = ifelse(azimuth_pbmcref1_score < 0.4, "unknown", azimuth_pbmcref1)) |>
    mutate(azimuth_pbmcref2 = ifelse(azimuth_pbmcref2_score < 0.4, "unknown", azimuth_pbmcref2)) |>
    mutate(azimuth_pbmcref3 = ifelse(azimuth_pbmcref3_score < 0.4, "unknown", azimuth_pbmcref3))
